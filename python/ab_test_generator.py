...
def generate_test_pages(num_pages):
    xml = '<root>'  # Add a root element
    for i in range(num_pages):
        xml += f'<page id="test-{i}" hostURL="eval_audio/" randomiseOrder="true" repeatCount="0" loop="false"\n'
        xml += '    synchronous="false" loudness="-12" label="default" labelStart="" poolSize="0"\n'
...
if __name__ == "__main__":
    ...
    test_pages = generate_test_pages(args.num_pages)
